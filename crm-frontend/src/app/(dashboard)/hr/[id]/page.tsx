...
import { ArrowLeft, User, Phone, Mail, MapPin, Plus, FileText, Briefcase, Clock, Calendar, RefreshCw, Save } from "lucide-react";
...
export default function HrDetail() {
  ...
  const badgeCls = STATUS_STYLES[candidate.status] ?? "bg-gray-100 text-gray-800 border-gray-200";
    ...
    <div className="flex flex-col h-full animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex items-center justify-between pr-[150px] min-h-[48px] mb-6 shrink-0">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Badge className={`font-medium px-2.5 py-0.5 shadow-sm border ${badgeCls}`}>{candidate.status}</Badge>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button onClick={() => setIsFollowUpOpen(true)} variant="outline" className="rounded-full px-6 py-5 bg-background shadow-sm">
            <Clock className="h-4 w-4 mr-2 text-muted-foreground" /> Timeline
          </Button>
      ...
      <div className="flex-1 overflow-y-auto min-h-0 pb-6 pr-2 space-y-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <div className="xl:col-span-1 bg-card border rounded-2xl p-6 shadow-sm">
            <h3 className="text-base font-bold text-foreground border-b pb-3 mb-5 flex items-center gap-2">
        ...
        {/* ── Row 2: Interview Details + New Follow Up ── */}
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          <div className="xl:col-span-2 bg-card border rounded-2xl p-6 shadow-sm h-full">
             <h3 className="text-base font-bold text-foreground border-b pb-3 mb-5 flex items-center gap-2">
